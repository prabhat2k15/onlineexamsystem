...
<% 
 ...
 <form name="myForm" method="post" action="anssubmit.jsp" >
  <%String stream="";
	  ...
	  try
	 {
		...
		Statement st=con.createStatement();
		 ResultSet rs=st.executeQuery("select * from "+stream);
		  ...
		  { 
			out.println("<br><font color=black size=5>"+rs.getString(1)+".");
			out.println(rs.getString(2)+"</font><br>");
			out.println("a)<input type='radio' name=r"+i+" value="+rs.getString(3)+">"+rs.getString(3)+"&nbsp&nbsp&nbsp&nbsp");
			out.println("b)<input type='radio' name=r"+i+" value="+rs.getString(4)+">"+rs.getString(4)+"<br>");
			out.println("c)<input type='radio' name=r"+i+" value="+rs.getString(5)+">"+rs.getString(5)+"&nbsp&nbsp&nbsp&nbsp");
			out.println("d)<input type='radio' name=r"+i+" value="+rs.getString(6)+">"+rs.getString(6)+"<br><br>");
